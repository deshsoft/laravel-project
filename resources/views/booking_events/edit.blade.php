                    ...
                    <div class="p-6 text-gray-900">
                        <div class="row gap-4">
                            ...
                            <div class="mb-4 col">
                                ...
                                <select name="fk_customer" class="w-full px-4 py-2 border rounded-md focus:outline-none select2"
                                    required>
                                            ...
                                            @foreach($assets as $asset)
                                                @if($asset->mode == 'aggregable')
                                                    ...
                                                    <tr>
                                                        ...
                                                        class="total-input"
                                                        min="1" placeholder="Total" value="{{ $rentalValue }}">
                                                        </td>
                        ...
                        <div>
                            <table id="bookingSlots" class="w-full border-collapse border border-gray-300">
                                    ...
                                    <tr class="booking-slot">
                                        <td class="border border-gray-300 px-2 py-2">
                                            <input type="text" name="slots[0][from_date]"
                                                class="w-full px-2 py-2 border rounded-md focus:outline-none from-date" value="{{ \Carbon\Carbon::parse($slot->from_date)->format('d/m/Y') }}"
                                        ...
                                        <td class="border border-gray-300 px-2 py-2">
                                            <input type="text" name="slots[0][to_date]"
                                                class="w-full px-2 py-2 border rounded-md to-date" value="{{ $slot->to_date ? \Carbon\Carbon::parse($slot->to_date)->format('d/m/Y') : '' }}" autocomplete="off">
                                        </td>
                                        <td class="border border-gray-300 px-2 py-2">
                                            <input type="hidden" name="slots[0][aggregable_price]" value="{{ $slot->aggregable_price }}"
                                                class="w-full px-2 py-2 border rounded-md aggregable-price" readonly>
                                                <span class="aggregable-price-display">{{ number_format($slot->aggregable_price, 2, ',', '.') }}</span>
                                        </td>
                                        <td class="border border-gray-300 px-2 py-2">
                                            <input type="hidden" name="slots[0][non_aggregable_price]" value="{{ $slot->non_aggregable_price }}"
                                                class="w-full px-2 py-2 border rounded-md non-aggregable-price"
                                                readonly>
                                                <span class="non-aggregable-price-display">{{ number_format($slot->non_aggregable_price, 2, ',', '.') }}</span>
                                        </td>
                                        <td class="border border-gray-300 px-2 py-2">
                                            <input type="hidden" name="slots[0][slot_price]"
                                                class="w-full px-2 py-2 border rounded-md slot-price" value="{{ $slot->slot_price }}" readonly>
                                                <span class="slot-price-display">{{ number_format($slot->slot_price, 2, ',', '.') }}</span>
                                        </td>
                                        <td class="border border-gray-300 px-2 py-2 text-center">
                                            <button type="button"
                                ...
                                <tfoot>
                                    ...
                                    <td class="border border-gray-300 px-2 py-2">
                                        <input type="hidden" id="total_price" name="total_price" value="{{ $bookingEvent->total_price }}"
                                            class="w-full px-4 py-2 border rounded-md" readonly>
                                            <span id="total_price_display">{{ number_format($bookingEvent->total_price, 2, ',', '.') }}</span>
                                    </td>
                                    <td class="border border-gray-300 px-2 py-2 text-center">
                        ...
                        <div class="row">
                            ...
                            <div class="mb-4 col">
                                ...
                                <input type="hidden" id="final_price" name="final_price"
                                    ...
                                    readonly>
                                    <span id="final_price_display">{{ number_format($bookingEvent->final_price, 2, ',', '.') }}</span>
                            </div>
                            ...
                            <div class="mb-4 col">
                                ...
                                <input type="hidden" name="vat_amount" id="vat_amount"
                                    ...
                                    min="0">
                                    <span id="vat_amount_display">{{ number_format($bookingEvent->vat_amount, 2, ',', '.') }}</span>
                            </div>
                            ...
                            <div class="mb-4 col">
                                ...
                                <input type="hidden" id="final_price_with_vat" name="final_price_with_vat"
                                    ...
                                    class="w-full px-4 py-2 border rounded-md" readonly>
                                    <span id="final_price_with_vat_display">{{ number_format($bookingEvent->final_price_with_vat, 2, ',', '.') }}</span>
                            </div>
